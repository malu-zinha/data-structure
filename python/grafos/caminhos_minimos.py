...
Rode a partir da pasta `python/`:  python3 -m grafos.caminhos_minimos
"""

import heapq  # heap mínimo da biblioteca padrão (veja arvores/heap.py)
from itertools import count

from grafos.buscas import reconstruir_caminho
