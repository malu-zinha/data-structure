...
Rode a partir da pasta `python/`:  python3 queue/fila_duas_pilhas.py
"""

import sys
from pathlib import Path

sys.path.append(str(Path(__file__).resolve().parent.parent / "stack"))

from pilha_encadeada import PilhaEncadeada  # noqa: E402
